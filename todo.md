...
|---|---|---|---|
| Current agent workflow cleanup | 🔧 in_progress | P0 | Goal: `docs/context/goals/proportional-review-workflow.md`; epic: `docs/context/epics/current-agent-workflow-cleanup.md`; manifest: `docs/plans/2026-07-30-010-kb-current-agent-workflow-cleanup-manifest.md`; next: `kb-work` |
