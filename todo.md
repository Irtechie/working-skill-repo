...
|---|---|---|---|
| Bounded graph-run provenance | 🔧 in_progress | P0 | Slice 001 storage lifecycle; manifest: `docs/plans/2026-07-30-000-kb-bounded-graph-run-provenance-manifest.md` |
