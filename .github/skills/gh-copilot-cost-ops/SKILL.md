...
**Model credit rates:** Confirm current rates against the GitHub model pricing
reference before relying on them. Rates observed as of 2026-07 (per 1M tokens):
GPT-5.4 input $2.50/$0.25 cached / $15.00 output; Claude Sonnet 4.6 input
$3.00/$0.30 cached / $3.75 write / $15.00 output.
